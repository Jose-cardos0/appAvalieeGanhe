  ...
  const handleTransfer = (e: React.FormEvent) => {
    ...
    notification.innerHTML = `
      <div class="flex items-center gap-3 w-full">
        ...
        <div class="flex-1">
          <p class="font-medium text-[14px] leading-tight">Transferencia realizada con éxito</p>
          <p class="text-[13px] text-white/90">Has transferido: US$ ${transferAmount.toFixed(
            2
          )}</p>
        </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden">
        <div className="p-6">
          <h2 className="text-2xl font-semibold mb-6">Transferir dinero</h2>
